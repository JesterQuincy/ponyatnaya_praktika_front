            ...
            {clientType === 'adult' && (
              <div className="space-y-[13px]">
                <div className="space-y-[5px]">
                  <label className="font-montserrat text-xs font-medium">ФИО</label>
                  <Input
            ...
            {clientType === 'child' && (
              <div className="space-y-[40px]">
                ...
                <div>
                  <div className="space-y-[13px]">
                    <div className="space-y-[5px]">
                      <label className="font-montserrat text-xs font-medium">ФИО Родителя</label>
                      <Input
                        className="h-[31px] rounded-xl"
                        type="text"
              ...
              <div className="space-y-[40px]">
                <div className="space-y-[13px] ">
                  <div>
                    ...
                    <Input type="text" placeholder="ФИО клиента №1" required {...register('fullName')} />
                  </div>
                ...
                <div>
                  <div className="space-y-[13px]">
                    <div className="space-y-[5px]">
                      <label className="font-montserrat text-xs font-medium">ФИО клиента №2</label>
                      <Input
                        className="h-[31px] rounded-xl"
                        type="text"
                        placeholder={'Введите ФИО клиента №2'}
                        required
                        {...register('client2FullName')}
                      />
                    </div>
                    <div className="flex flex-row w-full space-x-[10px]">
                      <div className="flex flex-col space-y-[5px]">
